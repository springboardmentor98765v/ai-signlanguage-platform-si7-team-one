...
export default function LoginScreen({
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Left panel */}
      <div className="hidden lg:flex w-[45%] bg-[#FAFAFA] flex-col justify-between p-12 relative overflow-hidden border-r border-border">
        <div className="absolute -top-20 -right-20 w-80 h-80 bg-primary/5 rounded-full blur-3xl" />
        <div className="absolute bottom-10 left-1/4 w-48 h-48 bg-primary/3 rounded-full blur-2xl" />
        <div className="absolute top-32 right-12 opacity-15">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="font-bold text-lg text-[#222222]">SignPath AI</span>
          </div>
          <h1 className="text-4xl font-bold text-[#222222] leading-tight mb-4">
            Learn sign language<br />
            <span className="text-[#DB3100]">with real-time AI</span>
          </h1>
        ...
        <div className="relative space-y-3.5">
          {[
            ...
            <div key={t} className="flex items-center gap-3 text-sm text-[#6B7280]">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="flex gap-1.5 mb-6 p-1.5 bg-muted rounded-xl">
            {(["learner", "instructor", "trainer", "admin"] as Role[]).map(r => (
              <button
                key={r}
                onClick={() => setSelectedRole(r)}
                className={`flex-1 py-2 text-[11px] font-semibold rounded-lg capitalize transition-all ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-card border border-border rounded-xl pl-10 pr-4 py-3 text-foreground text-sm focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-card border border-border rounded-xl pl-10 pr-10 py-3 text-foreground text-sm focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20"
                />
                <button
          ...
          <button className="w-full bg-card border border-border hover:bg-hover text-foreground font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-3 mb-6 text-sm">
