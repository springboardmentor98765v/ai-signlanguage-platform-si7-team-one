...
description: >
  Anthropic Claude design system analysis — warm-canvas editorial interface.
  Use when building Claude-branded UIs, reviewing design consistency against
  the Anthropic design language, or generating components that match claude.com's
  visual identity. Covers cream/coral palette, serif display type, dark product
  surfaces, component specs, spacing, and layout rules.
---
